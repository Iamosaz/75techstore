    ...
    <div className="p-6 space-y-6 max-w-4xl">
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
        ...
        <button
          ...
          className="mt-5 flex items-center gap-2 bg-blue-600 hover:bg-blue-700 disabled:opacity-60 text-white px-6 py-2.5 rounded-xl text-sm font-medium transition"
        >
          {profileLoading ? (
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
        ...
        <div className="space-y-4">
          ...
          <button
            ...
            className="flex items-center gap-2 bg-blue-600 hover:bg-blue-700 disabled:opacity-60 text-white px-6 py-2.5 rounded-xl text-sm font-medium transition"
          >
            {passwordLoading ? (
              <div className="w-4 h-4 border-2 border-white border-t-transparent rounded-full animate-spin" />
            ) : (
        ...
        <div className="space-y-3">
          {[
            ...
            },
            {
              ...
              description: "Get notified about low stock items",
              icon: FiBell,
            },
          ].map((item) => (
            <label
