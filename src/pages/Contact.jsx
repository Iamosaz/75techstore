...
const Contact = () => {
  ...
  const contactMethods = [
    ...
    },
    {
      ...
      contact: 'support@75techstore.com',
      link: 'mailto:support@75techstore.com',
  ...
  return (
    <>
      {/* ════════════════════════════════════════════════════════════ */}
      {/* HERO SECTION - IMPROVED COLORS & BUTTON VISIBILITY */}
      {/* ════════════════════════════════════════════════════════════ */}
      <section className='relative min-h-screen flex items-center justify-center 
        overflow-hidden pt-20 pb-20'>

        {/* Background - LIGHTER FOR BETTER BUTTON VISIBILITY */}
        <div className='absolute inset-0 bg-gradient-to-b from-white via-gray-50 to-gray-100 -z-10'>
          ...
          <div className='absolute top-0 left-0 w-96 h-96 bg-blue-300/15 rounded-full 
            blur-3xl opacity-40' />
          <div className='absolute top-1/2 right-0 w-96 h-96 bg-yellow-300/15 rounded-full 
            blur-3xl opacity-40' />
          <div className='absolute bottom-0 left-1/2 w-96 h-96 bg-purple-300/15 rounded-full 
            blur-3xl opacity-40' />
        </div>
        ...
        >
          {/* Badge */}
          <motion.div
            className='inline-flex items-center gap-2 bg-yellow-400/20 border border-yellow-500/60 
              rounded-full px-6 py-2.5 mb-6 backdrop-blur-md hover:border-yellow-500 
          ...
          >
            ...
            <span className='text-yellow-700 font-semibold text-sm uppercase tracking-widest'>
              Get in Touch
            </span>
          </motion.div>
          ...
          >
            Let's Connect &
            <br />
            <span className='bg-gradient-to-r from-yellow-500 via-orange-500 to-red-600 
              bg-clip-text text-transparent'>Talk Tech</span>
          </motion.h1>
          ...
          >
            ...
            <motion.a
              ...
              className='group relative px-8 py-4 rounded-xl font-bold text-lg
                ...
                shadow-2xl hover:shadow-green-500/60
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className='group relative px-8 py-4 rounded-xl font-bold text-lg
                text-white bg-gradient-to-r from-yellow-500 to-orange-600 
                hover:from-yellow-600 hover:to-orange-700 
                shadow-2xl hover:shadow-yellow-500/60
                transition-all duration-300 flex items-center gap-3
          ...
          >
            Or call us directly: <span className='font-bold text-gray-900'>+234 703 562 0709</span>
          </motion.p>
        </motion.div>
      </section>
      ...
      {/* CONTACT METHODS */}
      {/* ════════════════════════════════════════════════════════════ */}
      <section className='py-20 bg-gradient-to-b from-gray-100 via-white to-gray-50'>
            ...
            {contactMethods.map((method, index) => (
              <motion.a
                ...
                className={`group relative rounded-3xl p-8 overflow-hidden
                  ...
                  ${method.bgColor} border-2 border-gray-200 hover:border-gray-300`}
              >
                {/* Icon */}
                <motion.div
                  className={`${method.textColor} text-4xl mb-6 group-hover:scale-110 
                ...
                <div className={`absolute bottom-0 left-0 right-0 h-1 bg-gradient-to-r 
                  ${method.color} transform scale-x-0 group-hover:scale-x-100 
        ...
        <div className='max-w-4xl mx-auto px-6'>
          ...
          >
            ...
            <AnimatePresence>
              {submitted && (
                <motion.div
                  ...
                  animate={{ opacity: 1, y: 0 }}
                  exit={{ opacity: 0, y: -20 }}
                  className='mb-8 p-6 bg-green-100 border-2 border-green-500 rounded-2xl 
            ...
            <form
              ...
              className='bg-gradient-to-br from-gray-50 to-gray-100 border-2 border-gray-200 
            ...
            >
              <div className='grid md:grid-cols-2 gap-6 mb-6'>
                ...
                <motion.div
                  ...
                  transition={{ delay: 0.1 }}
                >
                  <label className='block text-gray-900 font-bold text-sm mb-3 uppercase tracking-widest'>
                    Full Name *
                  </label>
                  <input
                    type='text'
                    ...
                    required
                    className={`w-full px-6 py-3.5 rounded-xl bg-white border-2
                      transition-all duration-300 text-gray-900 placeholder-gray-400
                      focus:outline-none 
                      ${focusedField === 'name' ? 'border-yellow-500 shadow-lg shadow-yellow-200' : 'border-gray-300 hover:border-gray-400'}`}
                ...
                >
                  ...
                  <input
                    ...
                    className={`w-full px-6 py-3.5 rounded-xl bg-white border-2
                      transition-all duration-300 text-gray-900 placeholder-gray-400
                      focus:outline-none 
                      ${focusedField === 'email' ? 'border-yellow-500 shadow-lg shadow-yellow-200' : 'border-gray-300 hover:border-gray-400'}`}
              ...
              <div className='grid md:grid-cols-2 gap-6 mb-6'>
                ...
                >
                  ...
                  <input
                    ...
                    className={`w-full px-6 py-3.5 rounded-xl bg-white border-2
                      transition-all duration-300 text-gray-900 placeholder-gray-400
                      focus:outline-none 
                      ${focusedField === 'phone' ? 'border-yellow-500 shadow-lg shadow-yellow-200' : 'border-gray-300 hover:border-gray-400'}`}
                ...
                >
                  ...
                  <select
                    ...
                    onChange={handleInputChange}
                    className='w-full px-6 py-3.5 rounded-xl bg-white border-2 
                      border-gray-300 hover:border-gray-400 transition-all duration-300 
                      text-gray-900 focus:outline-none focus:border-yellow-500 
              ...
              >
                ...
                <input
                  ...
                  className={`w-full px-6 py-3.5 rounded-xl bg-white border-2
                    transition-all duration-300 text-gray-900 placeholder-gray-400
                    focus:outline-none 
                    ${focusedField === 'subject' ? 'border-yellow-500 shadow-lg shadow-yellow-200' : 'border-gray-300 hover:border-gray-400'}`}
              ...
              >
                ...
                <textarea
                  ...
                  className={`w-full px-6 py-3.5 rounded-xl bg-white border-2
                    ...
                    ${focusedField === 'message' ? 'border-yellow-500 shadow-lg shadow-yellow-200' : 'border-gray-300 hover:border-gray-400'}`}
              ...
              <motion.button
                ...
                className='w-full md:w-fit group relative px-8 py-4 
                  ...
                  hover:from-yellow-600 hover:to-orange-700 text-white font-bold rounded-xl 
                  transition-all duration-300 flex items-center justify-center gap-2 shadow-lg 
                  hover:shadow-yellow-500/60 text-lg disabled:opacity-50 disabled:cursor-not-allowed
              ...
              >
                ...
                {loading ? (
                  ...
                  <>
                    <FaPaperPlane size={18} className='relative z-10 group-hover:scale-110 transition-transform' />
                    <span className='relative z-10'>Send Message</span>
                  </>
                )}
              </motion.button>
        ...
        <div className='max-w-4xl mx-auto px-6'>
          ...
          >
            {faqs.map((faq, index) => (
              ...
              >
                {/* Icon */}
                <div className='text-yellow-500 text-2xl mb-4 group-hover:scale-110 
                  transition-transform duration-300'>
                  {faq.icon}
                </div>
        ...
        <div className='max-w-4xl mx-auto px-6 text-center'>
          ...
          >
            ...
            <div className='flex flex-wrap justify-center gap-6'>
              {[
                { icon: <FaInstagram size={32} />, link: 'https://instagram.com/75techstore', name: 'Instagram', color: 'from-pink-500 to-orange-500' },
                { icon: <FaFacebook size={32} />, link: 'https://facebook.com/75techstore', name: 'Facebook', color: 'from-blue-600 to-blue-700' },
                { icon: <FaWhatsapp size={32} />, link: 'https://wa.me/2347035620709', name: 'WhatsApp', color: 'from-green-500 to-green-600' },
                { icon: <FaTiktok size={32} />, link: 'https://tiktok.com/@75techstore', name: 'TikTok', color: 'from-gray-900 to-black' },
                { icon: <FaTwitter size={32} />, link: 'https://twitter.com/75techstore', name: 'Twitter', color: 'from-blue-400 to-blue-500' },
                { icon: <FaLinkedin size={32} />, link: 'https://linkedin.com/company/75techstore', name: 'LinkedIn', color: 'from-blue-600 to-blue-700' },
              ].map((social, index) => (
                <motion.a
                  key={index}
                  href={social.link}
      ...
      <section className='relative py-20 overflow-hidden bg-gradient-to-b 
        ...
        {/* Animated orbs */}
        <div className='absolute top-0 right-0 w-80 h-80 bg-yellow-300/20 rounded-full 
          blur-3xl opacity-40' />
        <div className='absolute bottom-0 left-0 w-80 h-80 bg-orange-300/20 rounded-full 
          blur-3xl opacity-40' />
        ...
        >
          ...
          <p className='text-xl text-gray-700 mb-12 max-w-2xl mx-auto'>
            Whether you need tech support, want to explore our products, or have a business inquiry, 
          ...
          <div className='flex flex-col sm:flex-row gap-6 justify-center items-center'>
            <motion.a
              ...
              whileHover={{ scale: 1.05, y: -5 }}
              whileTap={{ scale: 0.95 }}
              className='group relative px-10 py-4 bg-gradient-to-r from-green-500 to-emerald-600 
                hover:from-green-600 hover:to-emerald-700 text-white font-bold rounded-xl 
                transition-all duration-300 flex items-center gap-2 shadow-2xl 
                hover:shadow-green-500/60 text-lg overflow-hidden border border-green-400/30'
            >
              {/* Shine effect */}
              <div className='absolute inset-0 bg-gradient-to-r from-transparent via-white/20 to-transparent
                transform translate-x-full group-hover:translate-x-0 transition-transform duration-500' />
            ...
            <motion.a
              ...
              whileHover={{ scale: 1.05, y: -5 }}
              whileTap={{ scale: 0.95 }}
              className='group relative px-10 py-4 bg-gradient-to-r from-yellow-500 to-orange-600 
                hover:from-yellow-600 hover:to-orange-700 text-white font-bold rounded-xl 
                transition-all duration-300 flex items-center gap-2 shadow-2xl 
                hover:shadow-yellow-500/60 text-lg overflow-hidden border border-yellow-400/30'
            >
              {/* Shine effect */}
              <div className='absolute inset-0 bg-gradient-to-r from-transparent via-white/20 to-transparent
                transform translate-x-full group-hover:translate-x-0 transition-transform duration-500' />
